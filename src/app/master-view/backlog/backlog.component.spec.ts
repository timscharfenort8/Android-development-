...
describe('BacklogComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [ BacklogComponent, NoopAnimationsModule, FormsModule, HttpClientTestingModule, IGX_LIST_DIRECTIVES, IgxAvatarComponent, IgxIconComponent, IgxButtonDirective, IgxRippleDirective, IgxIconButtonDirective, IGX_INPUT_GROUP_DIRECTIVES, IGX_TABS_DIRECTIVES, IGX_GRID_DIRECTIVES ]
    })
    .compileComponents();
  });
